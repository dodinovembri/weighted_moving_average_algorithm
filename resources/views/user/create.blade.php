            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>Create User</span></h5>
                        ...
                        <div id="input-fields" class="card card-tabs">
                            <div class="card-content">
                                <div id="view-input-fields">
                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            <form method="post" action="{{ url('user/store') }}" class="row">
                                                @csrf
                                                <div class="col s12">
                                                    <div class="input-field col s12">
                                                        <input placeholder="Enter your name" id="first_name1" name="name" type="text" class="validate">
                                                        <label for="first_name1">Name</label>
                                                    </div>
                                                </div>
                                                <div class="col s12">
                                                    <div class="input-field col s12">
                                                        <input placeholder="Enter your email" name="email" id="disabled" type="text" class="validate">
